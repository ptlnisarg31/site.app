...
<head>
    ...
    <!-- Bootstrap-Core-CSS -->
    <link rel="stylesheet" href="css/about.contact.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <!-- font-awesome-icons -->
...
<body>
    ...
    <div class="main-banner inner" id="home">
        ...
        <header class="header">
            <div class="container-fluid px-lg-5">
                ...
                <nav class="py-4">
                    <div id="logo">
                        <h1> <a href="index.php">Minute Maintanance</a></h1>
                    </div>
                    ...
                    <li>
                        ...
                        <a href="partnersdemo.php">Partners</a>
						</li>
						<li>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-3">
            <h3 class="tittle text-center"><span class="sub-tittle">Find Us</span> About Us</h3>
            <div class="row contact-main-info mt-5">
             <h4></h4>
			     <p>Gyanmanjari Group of Colleges
Survey No.30, Sidsar Road, near Iscon Eleven, Bhavnagar, Gujarat 364001</p>
...
Survey No.30, Sidsar Road, near Iscon Eleven, Bhavnagar, Gujarat 364001</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3706.5908876314365!2d72.11971611494438!3d21.71860658562872!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395f574ba735c539%3A0x387d9b85bd2cd04e!2sGyanmanjari%20Group%20of%20Colleges!5e0!3m2!1sen!2sin!4v1635065094496!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            ...
            <div class="row footer-top">
                <div class="col-lg-4 footer-grid_section_w3layouts">
                    <h2 class="logo-2 mb-lg-4 mb-3">
                        <a href="index.php">Minute Maintanance</a>
                    </h2>
